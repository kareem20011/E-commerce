            ...
            <div>
                <div class="d-flex justify-content-center mb-4">
                    @if(count(auth('admin')->user()->getMedia('images')) > 0)
                        <img id="avatar" src="{{ auth('admin')->user()->getFirstMedia('images')->getUrl() }}" class="rounded-circle" style="width: 200px; height: 200px; object-fit: cover;" />
                    @else
                        <img class="rounded-circle" src="{{ asset('media/temp.jpeg') }}" style="width: 200px; height: 200px; object-fit: cover;" style="width: 200px; height: 200px; object-fit: cover;">
                    @endif
                </div>
