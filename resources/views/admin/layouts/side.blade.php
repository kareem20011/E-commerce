            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle {{ Request::is('admin/mainCategories') || Request::is('admin/subCategories') ? 'active' : '' }}" data-bs-toggle="dropdown"><i class="fa fa-list-alt me-2" aria-hidden="true"></i>Categories</a>
...
@yield('admin.content')
    ...
    <script src="{{ asset('admin/js/jqery-3.4.1.min.js') }}"></script>
